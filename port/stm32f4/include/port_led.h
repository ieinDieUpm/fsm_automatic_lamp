...
#define LED_LAMP_GPIO GPIOB   /*!< GPIO port of the heating LED */
#define LED_LAMP_PIN 4        /*!< GPIO pin of the heating LED */
#define LED_STATUS_GPIO GPIOA /*!< GPIO port of the deactivation LED */
#define LED_STATUS_PIN 5      /*!< GPIO pin of the deactivation LED */
...
/* Global variables -----------------------------------------------------------*/
extern port_led_hw_t led_lamp;   /*!< Heating LED of the automatic lamp. */
extern port_led_hw_t led_status; /*!< Cooling LED of the automatic lamp. */
